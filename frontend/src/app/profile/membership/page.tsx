...
import {
  Card, Button, Space, Row, Col, Typography, Table, Tag, Tooltip,
} from "antd";
import {
  CrownOutlined,
  CheckOutlined,
...
import { TierListResponse, OrderInfo, MembershipInfo, MembershipTier } from "@/types";
...
const orderColumns = [
  ...
  },
  {
    ...
    dataIndex: "tier",
    key: "tier",
    render: (v: string) => <Tag color={TIER_COLORS[v]}>{TIER_NAME_MAP[v] || v}</Tag>,
  },
  {
    title: "金额",
    dataIndex: "amount",
